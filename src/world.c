...
void world_init(void) {
    ...
    OFFSET_WAYPOINTS = LEN_WORLD;

#define WAYPOINT_COLOR ((Vec4f){0.1f, 1.0f, 0.3f, WAYPOINT_ALPHA})
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(-13.5f, 13.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(-13.5f, -23.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(14.0f, -23.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(14.0f, -11.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(24.5f, -11.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(24.5f, 11.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, 11.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, 13.5f, WAYPOINT_COLOR);
#undef WAYPOINT_COLOR

#define WAYPOINT_COLOR ((Vec4f){0.85f, 0.4f, 0.9f, WAYPOINT_ALPHA})
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(0.6f, 13.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(0.6f, -4.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(-13.5f, -4.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(0.6f, -23.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(8.0f, -23.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(8.0f, -6.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(0.6f, -6.5f, WAYPOINT_COLOR);
#undef WAYPOINT_COLOR

#define WAYPOINT_COLOR ((Vec4f){0.9f, 0.8f, 0.4f, WAYPOINT_ALPHA})
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(19.0f, -11.0f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(19.0f, 11.0f, WAYPOINT_COLOR);
#undef WAYPOINT_COLOR

#define WAYPOINT_COLOR ((Vec4f){1.0f, 0.45f, 0.25f, WAYPOINT_ALPHA})
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, -6.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(4.35f, -6.5f, WAYPOINT_COLOR);
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, 10.0f, WAYPOINT_COLOR);
#undef WAYPOINT_COLOR
