...
#define WAYPOINT_COLOR ((Vec4f){1.0f, 0.45f, 0.25f, WAYPOINT_ALPHA})
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, -6.5f, WAYPOINT_COLOR); // 17
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(4.35f, -6.5f, WAYPOINT_COLOR); // 18
    WORLD_CUBES(LEN_WORLD++) = WAYPOINT(13.5f, 10.0f, WAYPOINT_COLOR); // 19
#undef WAYPOINT_COLOR
